...
class RC2(object):
    ...
    def exhaust_core(self, tobj):
        ...
        for i in xrange(2, len(self.rels)):
    ...
    def filter_assumps(self):
        ...
        self.bnds = {l: b for l, b in self.bnds.iteritems() if l not in self.garbage}
        self.wght = {l: w for l, w in self.wght.iteritems() if l not in self.garbage}
...
class RC2Stratified(RC2, object):
    ...
    def init_wstr(self):
        ...
        for s, w in self.wght.iteritems():
