#ifndef GLUCOSEPARA_PROVER_H
#define GLUCOSEPARA_PROVER_H
...
class GlucoseParaProver : public Prover {
private:
  shared_ptr<Glucose::ParallelSolver> solver =
      shared_ptr<Glucose::ParallelSolver>(new Glucose::ParallelSolver(0));
...
public:
  GlucoseParaProver(bool onesat = false);
  ~GlucoseParaProver();
  ...
  literal_set getModel();
    ...
    static shared_ptr<Glucose::ParallelSolver> completeSolver;
    shared_ptr<Glucose::ParallelSolver> calcSolver;
};
